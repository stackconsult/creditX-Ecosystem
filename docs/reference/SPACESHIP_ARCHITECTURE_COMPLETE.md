...
1. [RESEARCH VERIFICATION: Redis → Dragonfly Replacement](#research-verification)
...
- **✅ Confirmed:** Dragonfly is 100% Redis API-compatible drop-in replacement
...
│  CreditX UI | 91 Apps Dashboard | Guardian AI Console | etc │
└──────────────────┬──────────────────────────────────────────┘
                   │ REST API / WebSocket
┌──────────────────▼──────────────────────────────────────────┐
│                 API GATEWAY / ORCHESTRATION                  │
│        (Spaceship Starlight VM + Load Balancer)              │
│  Router | Authentication | Rate Limiting | Service Discovery │
└──────────────────┬──────────────────────────────────────────┘
                   │
        ┌──────────┼──────────┬──────────┐
        │          │          │          │
...
│ Database:          PostgreSQL 17 + PostGIS + TimescaleDB│
│ Cache:             Dragonfly (Redis 5.0 API compatible) │
